...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        ...
        mTasks = new WeakHashMap<String, DownloadTask>();
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            String url=intent.getStringExtra(IntentBundleKey.URL);
            String path=intent.getStringExtra(IntentBundleKey.PATH);
            if (isCancel) {
                Intent bIntent = new Intent(DOWNLOAD_CANCEL);
                DownloadService.this.sendBroadcast(bIntent);
            }else{
            	submit(url,path,false);
            }
        }
    ...
    private class DownloadTask implements HttpDownload.DownloadListener, HttpDownload.ProgressListener,
            HttpDownload.DivideDownloadListener {
