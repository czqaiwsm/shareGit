...
public class TabsActionBar {
    ...
    public TabsActionBar(Context context,
                         ScrollingTabContainerView sContainerView) {
        mContext = context;
    ...
    private void configureTab(Tab tab, int position) {
        final Tab tabi = tab;
        final TabsActionBar.TabListener callback = tabi.getCallback();
    ...
    public class Tab {
        private TabsActionBar.TabListener mCallback;
        private Object mTag;
        ...
        public TabsActionBar.TabListener getCallback() {
            return mCallback;
        }

        public Tab setTabListener(TabsActionBar.TabListener callback) {
            mCallback = callback;
            return this;
        }
        ...
        public Tab setCustomView(int layoutResId) {
            return setCustomView(LayoutInflater.from(mContext).inflate(
                    layoutResId, null));
        }
