package com.share.teacher.view.tab;
...
import com.share.teacher.utils.ScreenUtils;
...
public class ScrollingTabContainerView extends HorizontalScrollView
    ...
    public ScrollingTabContainerView(Context context) {
        super(context);
        setHorizontalScrollBarEnabled(false);//滚动条
        setContentHeight(context.getResources().getDimensionPixelSize(R.dimen.tab_bar_height));
        mStackedTabMaxWidth = ScreenUtils.getScreenWidth(context);
        mTabLayout = createTabLayout();
        addView(mTabLayout, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.MATCH_PARENT));
    }

    public ScrollingTabContainerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public ScrollingTabContainerView(Context context, AttributeSet attrs) {
    ...
    private TabView createTabView(TabsActionBar.Tab tab, boolean forAdapter) {
    ...
    public void addTab(TabsActionBar.Tab tab, boolean setSelected) {
    ...
    public void addTab(TabsActionBar.Tab tab, int position, boolean setSelected) {
    ...
    private class TabView extends LinearLayout implements OnLongClickListener {
        private TabsActionBar.Tab mTab;
        private TextView mTextView;
        private ImageView mIconView;
        private View mCustomView;

        public TabView(Context context, TabsActionBar.Tab tab, boolean forList) {
        ...
        @Override
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            super.onMeasure(getMeasuredWidth(), heightMeasureSpec);
        ...
        public void update() {
            final TabsActionBar.Tab tab = mTab;
...
//                    addView(imageView );
        ...
        public TabsActionBar.Tab getTab() {
            return mTab;
        }
    }
