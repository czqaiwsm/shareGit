...
public class CustomListView extends ListView implements OnScrollListener {
	...
	/** 加载中 */
	public final static int ENDINT_LOADING = 1;
	/** 手动完成刷新 */
	public final static int ENDINT_MANUAL_LOAD_DONE = 2;
	/** 自动完成刷新 */
	public final static int ENDINT_AUTO_LOAD_DONE = 3;
	/** 没有数据 */
	public final static int ENDINT_AUTO_LOAD_NO_DATA = 4;
	...
	public TextView mLastUpdatedTextView;
	private ImageView mArrowImageView;
	private ProgressBar mProgressBar;

	private View mEndRootView;
	public ProgressBar mEndLoadProgressBar;
	...
	public void autoRefresh(){
		...
		ValueAnimator valueAnimator = ValueAnimator.ofFloat(0,mHeadViewHeight);
